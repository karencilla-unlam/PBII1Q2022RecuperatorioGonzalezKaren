...
public class RecuperatorioTests {
	...
	public void queSePuedaEmitirUnaPolizaDeAutos() {
		...
		Persona asegurado = new Persona("Camila", (long) 45987345, 24);
	...
	public void queSePuedaEmitirUnaPolizaDeVida() {
		...
		Persona asegurado = new Persona("Camila", (long) 45987345, 24);
		Persona hijo = new Persona("Arturo", (long) 65456231, 2);
		Persona conyuge = new Persona("Arturo", (long) 65456231, 2);
	...
	public void queSePuedaEmitirUnaPolizaDeCombinadoFamiliar() {
		...
		Persona asegurado = new Persona("Camila", (long) 45987345, 24);
		Persona hijo = new Persona("Arturo", (long) 65456231, 2);
		Persona hija = new Persona("Maia", (long) 65445231, 4);
		Persona conyuge = new Persona("Arturo", (long) 65456231, 2);
	...
	public void queSePuedanAdministrarDistintosTiposDePolizas() {
		...
		libra.agregarPoliza(new PolizaDeAuto(1, new Persona("Camila", (long) 45987345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaDeAuto(2, new Persona("Juan", (long) 2745123, 24), 1500000.0, 4000.0));
		libra.agregarPoliza(new PolizaAccidentesPersonales(3, new Persona("Pedro", (long) 455647345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaCombinadoFamiliar(4, new Persona("Natalia", (long) 45987345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaDeAuto(4, new Persona("Victor", (long) 652354, 24), 2000000.0, 5000.0));
	...
	public void queSePuedaDenunciarElRoboDeUnAuto() throws PolizaInexistente {
		...
		libra.agregarPoliza(new PolizaDeAuto(numeroDePoliza, new Persona("Camila", (long) 45987345, 24), 2000000.0, 5000.0));
	...
	public void queSePuedaDenunciarUnSiniestroParaUnaPolizaDeVida() throws PolizaInexistente {
		...
		libra.agregarPoliza(new PolizaAccidentesPersonales(numeroDePoliza, new Persona("Pedro", (long) 455647345, 24), 2000000.0, 5000.0));
	...
	public void verificarQueNoSePuedaDenunciarUnSiniestroParaUnaPolizaQueNoExista() {
		...
		libra.agregarPoliza(new PolizaDeAuto(numeroDePoliza++, new Persona("Camila", (long) 45987345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaDeAuto(numeroDePoliza++, new Persona("Juan", (long) 2745123, 24), 1500000.0, 4000.0));
		libra.agregarPoliza(new PolizaAccidentesPersonales(numeroDePoliza++, new Persona("Pedro", (long) 455647345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaCombinadoFamiliar(numeroDePoliza++, new Persona("Natalia", (long) 45987345, 24), 2000000.0, 5000.0));
